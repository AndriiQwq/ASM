...
section .data
    ...
    error_of_reading_file db 0xa, 'Error of reading file.', 0xa, 'Exit code: 1', 0xa
    len_error_of_reading_file equ $ - error_of_reading_file
...
end_of_args:; MAIN BODI AFTER READING THE ARGUMENTS
    ; Check presents of the files
    cmp byte [count_of_files], 0
    je eror_exit_not_provided_correct_argument
...
process_file: ; Function to precess riading the current file name and processing the file
    ...
    cmp rax, 0
    jl file_read_error ; jamp less than 0, syscall open return error code then is less than 0
...
file_read_error:
    error_exit error_of_reading_file, len_error_of_reading_file
